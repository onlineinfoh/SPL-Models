...
| [`DISCLOSURE.md`](DISCLOSURE.md) | Material removed from this repository in an earlier commit, and restored |
...
| `test/` | Outside-cohort evaluation; see [`DISCLOSURE.md`](DISCLOSURE.md) |
